...
from helpers.formatters import (
    ...
    METHOD_LABEL,
    vitals_to_dataframe,
    vitals_to_json_payload,
    build_token_footer_html,
    build_summary_md,
)
...
def process_pdf(
    ...
    try:
        ...
        summary_md = build_summary_md(stats, patient_info, pdf_method, used_gemini, token_usage)
        ...
        footer_html = build_token_footer_html(stats, token_usage, used_gemini)
        ...
        return (
            ...
            gr.update(value=footer_html, visible=True),
        )
